export default function Footer() {
  return (
    <main className="bg-cyan-50">
      ...
      <div className="flex flex-col md:flex-row mt-8 border-t">
        <div className="md:w-3/4 ">
          <p className="text-center text-[#64748B] ">©Copyright UTFPR 2023-2 by Alunos de Web all rights reserved!</p>
        </div>
